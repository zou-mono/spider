...
def Crawl(vdatetime):
    ...
    # 定义post的参数
    body_value = {'hash': '451498b0a316c4efb0cc706fef293931',
                  'FROM_SELF': 'true',
                  'q_JCRQ': date,
                  'q_SDATE': hour,
                  'q_JCDW': '',
...
def main(argv):
    argv = ["-s", "2017-06-26 00:00:00", "-e", "2017-06-26 10:00:00"]
    ...
    #         opts, args = getopt.getopt(sys.argv[1:], "h:s:e:",["help", "start=", "end="])
    #     except getopt.GetoptError:
    #         print 'Error: getRJWData.py -s <start> -e <end>'
    #         print '   or: getRJWData.py --start=<start> --end=<end>'
    #         print '帮助使用参数-h或者--help'
    #         sys.exit(2)
    #
    #     for opt, arg in opts:
    #         if opt == "-h":
    #             print 'getRJWData.py -s <start> -e <end>'
    #             print 'or: getRJWData.py --start=<start> --end=<end>'
    #             sys.exit()
    #         elif opt in ("-s", "--start"):
    #             start = arg
